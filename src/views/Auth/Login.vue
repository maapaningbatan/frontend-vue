    ...
    {{ toastMessage }}
        ...
        <div class="flex items-center space-x-4 mb-6">
          <img
            src="/images/logo.png"
            alt="Logo"
            class="w-12 sm:w-14 h-auto select-none pointer-events-none"
            draggable="false"
          />
        ...
        <!-- Welcome -->
        <h2 class="text-2xl text-center sm:text-3xl font-bold text-gray-900 mb-8">Welcome Back</h2>
        ...
        <form @submit.prevent="login" class="space-y-6 select-text">
          ...
          <div>
            ...
            <div class="relative">
              ...
              />
              <i
                class="fas fa-user absolute left-3 top-1/2 -translate-y-1/2 text-gray-00 pointer-events-none"
              ></i>
              <Input
                v-model="form.login"
                id="login"
          ...
          <div>
            ...
            <div class="relative">
              ...
              />
              <i
                class="fas fa-lock absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"
              ></i>
              <Input
          ...
          <!-- Remember + Forgot -->
          <div
            class="pt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center text-sm gap-3"
          >
      ...
      <!-- Right: Illustration -->
      <div
        class="w-full sm:w-1/2 flex items-center justify-center bg-gray-100 p-6 select-none pointer-events-none"
      >
        <img
          src="/images/Image2.png"
          alt="Illustration"
          class="w-full h-auto max-h-[700px] sm:max-h-[900px] object-contain opacity-95 select-none pointer-events-none"
          draggable="false"
        />
      </div>
    </div>
